...
//listing pour test
tab_name.push("img/a1.png");
tab_name.push("img/a2.png");
tab_name.push("img/b.png");
tab_name.push("img/c.png");
tab_name.push("img/i1.png");
tab_name.push("img/score.png");
tab_name.push("img/sexe.png");
tab_name.push("img/taille.png");
tab_name.push("img/z.png");
...
navigation.createPellicule = function () {
    for (var i = 0; i < tab_name.length; i++) {
        pellicule.list.push(struct.createGraph(tab_name[i], tab_name[i].replace('img/', ''), null, null));
    }
